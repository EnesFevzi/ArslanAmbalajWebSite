...
namespace ArslanElArabaları.ViewComponents.AdminNavbarProfile
{
    public class AdminNavbarProfile : ViewComponent
    {
        ...
        public AdminNavbarProfile(UserManager<AdminUser> userManager, SignInManager<AdminUser> signInManager)
        {
