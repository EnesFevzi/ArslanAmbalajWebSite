    ...
    public partial class mig_add : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Experiences", x => x.ExprienceID);
                    table.ForeignKey(
                        name: "FK_Experiences_AspNetUsers_WriterID",
                        column: x => x.WriterID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostCreateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PostStatus = table.Column<bool>(type: "bit", nullable: true),
                    WriterID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.PortfolioID);
                    table.ForeignKey(
